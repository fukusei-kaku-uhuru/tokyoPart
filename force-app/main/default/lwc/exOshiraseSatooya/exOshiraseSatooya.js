...
import getOshiraseKojin from '@salesforce/apex/ExOshiraseSatooyaController.getLast5Record';
...
export default class ExOshiraseDV extends NavigationMixin(LightningElement) {
    ...
    goOshirase(event) {
        ...
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
                recordId: id,
                objectApiName: 'Satooya_ZentaiOshirase__c',
                actionName: 'view'
            }
        });
    }
    ...
    goAllData(event) {
        ...
        this[NavigationMixin.Navigate]({
            ...
            state: {
                'Satooya_ZentaiOshirase__c-filterId': 'All'
            }
        });
    }
