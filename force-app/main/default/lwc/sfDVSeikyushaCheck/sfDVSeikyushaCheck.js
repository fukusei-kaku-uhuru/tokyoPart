...
import getUserProfile from '@salesforce/apex/SfDVSeikyushaCheckController.getUserProfile';
import getNinteiSeikyu from '@salesforce/apex/SfDVSeikyushaCheckController.getNinteiSeikyu';
import getContentVersion from '@salesforce/apex/SfDVSeikyushaCheckController.getContentVersion';
import updateSeikyushaShinsaKekka from '@salesforce/apex/SfDVSeikyushaCheckController.updateSeikyushaShinsaKekka';
import getTeikeiCommentOptions from '@salesforce/apex/SfDVSeikyushaCheckController.getTeikeiCommentOptions';
...
export default class SfSeikyushaCheck extends LightningElement {
    ...
    async connectedCallback() {
        ...
        if(this.shinsaStatus === shinsachuStatus_00) {
            ...
            this.shinsaKekka  = result.Seikyusya__r.ShinsaKekka_00__c;
            if(result.Seikyusya__r.ShinsaKekkaComment_00__c) {
                this.comment = result.Seikyusya__r.ShinsaKekkaComment_00__c;
            }
        }
        if(this.shinsaStatus === shinsachuStatus_01) {
            ...
            this.hasCheckList = true;
            this.shinsaKekka  = result.Seikyusya__r.ShinsaKekka_01__c;
            if(result.Seikyusya__r.ShinsaKekkaComment_01__c) {
                this.comment = result.Seikyusya__r.ShinsaKekkaComment_01__c;
            }
        }
        if(this.shinsaStatus === shinsachuStatus_02) {
            ...
            this.hasCheckList = true;
            this.shinsaKekka  = result.Seikyusya__r.ShinsaKekka_02__c;
            if(result.Seikyusya__r.ShinsaKekkaComment_02__c) {
                this.comment = result.Seikyusya__r.ShinsaKekkaComment_02__c;
            }
        }
        if(this.shinsaStatus === shinsachuStatus_saishu) {
            this.isShinsachuSaishu = true;
            this.isTantosha        = result.IsSaishuShinsasya__c;
            this.shinsaKekka       = result.Seikyusya__r.ShinsaKekkaSaishu__c;
            if(result.Seikyusya__r.ShinsaKekkaComment_Saishu__c) {
                this.comment = result.Seikyusya__r.ShinsaKekkaComment_Saishu__c;
            }
        }
    ...
    get isPermissionError() {
        ...
        if(this.shinsaStatus === shinsachuStatus_saishu && saishuPermissionErrorProfile.includes(this.loginUserProfileName)) {
            return true;
        }
